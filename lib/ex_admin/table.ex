...
defmodule ExAdmin.Table do
  ...
  def build_th(field_name, opts),
    do: th(".th-#{parameterize field_name} #{humanize Map.get(opts, :label, to_string(field_name))}")
  ...
  def build_th(field_name, opts, _), do: build_th(field_name, opts)
